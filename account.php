...
<title>Online Exam|| TEST YOUR SKILL </title>
...
<nav class="navbar navbar-default title1">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#"><b>CSMSS Aurangabad</b></a>
    </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="col-md-4">
		 ...
		 <img src="image/CAM00121.jpg" width=100 height=100 alt="Gaurav Eknath Bakare" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="https://www.youtube.com/user/Gauravbakare26" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Gaurav Eknath Bakare</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 9595350831</h4>
		<h4 style="font-family:'typo' ">gauravbakare1@gmail.com</h4>
		<h4 style="font-family:'typo' ">Marathwada Institute Of Technology College in Aurangabad, Maharashtra</h4></div></div>
		</p>
      </div>
